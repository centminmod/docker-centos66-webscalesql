...
RUN yum -y install epel-release lynx wget nano which inotify-tools perl-DBI python-setuptools libaio && rm -rf /var/cache/*; echo "" > /var/log/yum.log && easy_install pip && easy_install supervisor && easy_install supervisor-stdout
